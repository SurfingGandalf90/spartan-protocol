  ...
  if (loading) return (
    <div style={{ minHeight: '100vh', background: '#0F0F0F', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <style>{`
        ...
        .shell-fill-base { opacity: 0.15; }
        .shell-fill-anim { animation: fillUp 1.8s cubic-bezier(0.4, 0, 0.2, 1) forwards; animation-delay: 0.2s; clip-path: inset(100% 0 0 0); }
        .shell-pulse { animation: pulse 2s ease-in-out infinite; animation-delay: 2s; }
      `}</style>
      <div style={{ position: 'relative', width: 72, height: 72 }}>
        <svg width={72} height={72} viewBox="0 0 48 48" fill="none" className="shell-fill-base" style={{ position: 'absolute', top: 0, left: 0 }}>
          <path d="M8,10 L40,10 L40,30 L24,44 L8,30 Z" fill="#1a1506" stroke="#E8C547" strokeWidth="1.4" strokeLinejoin="miter" />
          <path d="M11,13 L37,13 L37,29 L24,40 L11,29 Z" fill="none" stroke="#E8C547" strokeWidth="0.5" strokeOpacity="0.3" strokeLinejoin="miter" />
          <line x1="24" y1="2" x2="24" y2="46" stroke="#E8C547" strokeWidth="1.8" strokeLinecap="square" />
          <polygon points="24,1 29,13 24,10 19,13" fill="#E8C547" />
        ...
        <svg width={72} height={72} viewBox="0 0 48 48" fill="none" className="shell-fill-anim shell-pulse" style={{ position: 'absolute', top: 0, left: 0 }}>
          <path d="M8,10 L40,10 L40,30 L24,44 L8,30 Z" fill="#1a1506" stroke="#E8C547" strokeWidth="1.4" strokeLinejoin="miter" />
          <path d="M11,13 L37,13 L37,29 L24,40 L11,29 Z" fill="none" stroke="#E8C547" strokeWidth="0.5" strokeOpacity="0.3" strokeLinejoin="miter" />
          <line x1="24" y1="2" x2="24" y2="46" stroke="#E8C547" strokeWidth="1.8" strokeLinecap="square" />
          <polygon points="24,1 29,13 24,10 19,13" fill="#E8C547" />
